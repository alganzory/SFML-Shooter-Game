...
int main() {
	...
	loosing.setPosition(window.getSize().x/2, window.getSize().y/2);
	
	//TEXT
	sf::Text scoreOnScreen;
	scoreOnScreen.setPosition(window.getSize().x /2 - 120 , 3);
	...
	while (window.isOpen()) {
		...
		if (score % 100 == 40 ) { shotspeed += 0.00000006; }
